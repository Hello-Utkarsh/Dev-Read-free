...
const Hero = () => {
  ...
  return (
    <section className="mt-[10rem] text-white">
      <div className="max-w-screen mx-auto px-4 py-28 gap-12  md:px-8 xl:flex min-h-screen">
        <div className="space-y-5 max-w-2xl mx-auto text-center xl:text-left">
          ...
          <div className="items-center justify-center gap-x-3 space-y-3 sm:flex sm:space-y-0 xl:justify-start">
            ...
            <a
              href="javascript:void(0)"
              className="flex items-center justify-center gap-x-2 py-2 px-4 hover:border-gray-400 font-medium duration-150 active:bg-gray-100 border rounded-lg md:inline-flex"
            >
              Get access
              <svg
                xmlns="http://www.w3.org/2000/svg"
